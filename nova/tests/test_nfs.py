...
class NfsDriverTestCase(test.TestCase):
    ...
    def test_local_path(self):
        ...
        self.assertEqual(
            '/mnt/test/62885857003382734576599977129433850020/volume-123',
    ...
    def test_get_hash_str(self):
        ...
        self.assertEqual('62885857003382734576599977129433850020',
    ...
    def test_get_mount_point_for_share(self):
        ...
        self.assertEqual('/mnt/test/62885857003382734576599977129433850020',
